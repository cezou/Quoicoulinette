...
void test_ft_print_reverse_alphabet(void)
{
    ...
    else if (pid == 0)
    {
        ...
        // Appeler la fonction ft_print_reverse_alphabet
    ...
    {
        close(pipe_fds[1]);
        char expected_output[] = "zyxwvutsrqponmlkjihgfedcba\n";
        ...
        if (bytes_read == sizeof(received_output) - 1)
        {
            ...
            {
                 printf("Test: \033[1;32mApagnan! :)\n");
            }
            else
            {
                printf("Test: ");
                printf("Test: \033[1;31mQUOICOUBEH :O\n");
            }
